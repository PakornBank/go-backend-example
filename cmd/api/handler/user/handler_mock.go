...
// Source: github.com/PakornBank/go-backend-example/cmd/api/handler/user (interfaces: Handler)
//
// Generated by this command:
//
//	mockgen -destination=./handler_mock.go -package=user github.com/PakornBank/go-backend-example/cmd/api/handler/user Handler
//
