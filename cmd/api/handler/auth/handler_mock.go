...
// Source: github.com/PakornBank/go-backend-example/cmd/api/handler/auth (interfaces: Handler)
//
// Generated by this command:
//
//	mockgen -destination=./handler_mock.go -package=auth github.com/PakornBank/go-backend-example/cmd/api/handler/auth Handler
//
